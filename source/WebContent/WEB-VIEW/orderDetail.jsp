      ...
      <div class="row content-table">
        <table class="col-lg-12">
          ...
          <tr>
            ...
            <td><a href="${pageContext.request.contextPath}/searchadmin?keyword=${detail.nameProduct}" target="_blank">${detail.nameProduct}</a></td>
            <td>${detail.amountProduct}</td>
            <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${detail.priceProduct}" /><span>đ</span></td>
          </tr>
          </c:forEach>
        </table>
      </div> <!-- End Table -->
